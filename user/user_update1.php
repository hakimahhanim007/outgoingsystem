...
<body class="grey lighten-3">
  ...
  <?php
    ...
    $query = 'UPDATE login_user set name="'.$name.'", email_address = "'.$email_address.'", user_password = "'.$user_password.'", user_status = "'.$user_status.'", staffid = "'.$staffid.'", department = "'.$department.'", position = "'.$position.'" WHERE id ="'.$id.'" ';
