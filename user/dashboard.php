              ...
              <?php
                    ...
                    //  }else{
                       ...
                       require_once("include/connection.php");
                             ...
                             $sql ="SELECT *,count(upload_files.location_address) as count FROM upload_files JOIN location ON upload_files.location_address = location.id_location group by upload_files.location_address;";
                             $result = mysqli_query($conn,$sql);
                             $chart_data="";
                             while ($row = mysqli_fetch_array($result)) { 
                     
                                $name[]  = $row['location_address']  ;
                                $counts[] = $row['count'];
                            }
                    ...
                    ?>
                <CENTER><h3 class="page-header" >Count of Location File  </h3></CENTER>  
