         ...
         require_once("include/connection.php");
          ...
          ?>       
           ...
           <tr>
              ...
              <td align=''><?php echo $admin_position; ?></td>
              <!--<td align='' width="20%"><?php echo $pass; ?></td>-->
              <td align=''><?php echo $status; ?></td>
              <td align=''>
                <a href="#modalRegisterFormsss?id=<?php echo $rs['id']?>">
                <i class="fas fa-user-edit" data-toggle="modal" data-target="#modalRegisterFormsss"></i></a> | 
                <a href="delete_admin.php?id=<?php echo htmlentities($rs['id']); ?>"><i class='far fa-trash-alt'></i></a>
              </td>
           </tr>
