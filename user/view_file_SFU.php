...
<tbody>
    ...
    <tr>
      ...
      $query = mysqli_query($conn,"SELECT DISTINCT id,name,size,email,admin_status,timers,download,fileno,location_name,file_department FROM upload_files WHERE file_department='SFU' ") or die (mysqli_error($con));
