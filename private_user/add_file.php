...
<nav class="mb-1 navbar navbar-expand-lg navbar-dark default-color fixed-top">
    <a class="navbar-brand" href="#"><img src="js/img/Files_Download.png" width="33px" height="33px"> <font color="#F0B56F">F</font>ile <font color="#F0B56F">e-</font>archive<font color="#F0B56F">S</font>ystem</a>
    ...
    <div class="container">
      <div class="row"><br>
        <form action="fileprocess.php" method="post" enctype="multipart/form-data" >
          ...
          <footer style="font-size: 11px"><b>File Type:</b><font color="red"><i>.docx.pdf</i></font></footer>
        </form>
      </div>
