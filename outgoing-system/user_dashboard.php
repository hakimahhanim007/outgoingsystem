    ...
    <!-- Heading -->
      ...
      <div class="row">
        <div class="col-xl-3 col-md-6">
          <div class="card bg-primary text-white mb-4">
            ...
            <a class="small text-white stretched-link" href="user_viewmemo.php">View Details</a>
      ...
      <div class="col-xl-3 col-md-6">
          <div class="card bg-warning text-white mb-4">
            ...
            <div class="card-footer d-flex align_items-center justify-content-between">
            <a class="small text-white stretched-link" href="user_viewletter.php">View Details</a>
              <div class="small text-white">
              <i class="fas fa-angle-right"></i>
              </div>            
            </div>
