...
<body class="grey lighten-3">
  ...
  <header>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav mr-auto">
                     <li style="margin-top: 10px;"><strong>Welcome</strong></font>&nbsp;<?php echo "htmlentities$ id"; ?></li>&nbsp;
          ...
          <ul class="navbar-nav nav-flex-icons">
            <li class="nav-item">
              <a href="notification.php" class="nav-link border border-light rounded waves-effect">
    ...
    <?php include_once 'user_sidebar.php' ?> <!-- side navigation & module pop up add user. add admin, add location -->
