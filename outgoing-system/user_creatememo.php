      ...
      <h4 class="mb-2 mb-sm-0 pt-1">
            ...
            <div class="card mb-4 wow fadeIn mt-5">
                   ...
                   <div class="card-body justify-content-between">
                        ...
                        <form action="user_creatememodb.php" method="post">
                           
                            
                             <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label data-error="wrong" data-success="right" for="title" class="form-label">Memo Title</label>
                                 <input type="text" class="form-control" id="title" name="memo_title" required>
                            </div>
                                
                                <div class="col-md-6 mb-3">
                                  <label data-error="wrong" data-success="right" for="date" class="form-label">Date</label>
                                <input type="date" class="form-control" id="date" name="memo_date" required>
                             ...
                             <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="email" class="form-control" id="email" name="memo_email" required>
                                </div>
                                
                              <div class="col-md-6 mb-3">
                                    <label  data-error="wrong" data-success="right"  for="from" class="form-label">Reference (THBM/HQ-HR/TM/M/2024-001)</label>
                                    <input type="text" class="form-control" id="ref" name="memo_ref" required placeholder="eg: TM">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select" name="memo_from" required >
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="to" name="memo_to" required>
                                </div>
                            </div>
                           ...
                           <button type="submit" class="btn btn-primary" name="submitmemo">Submit</button>
                           </div>
