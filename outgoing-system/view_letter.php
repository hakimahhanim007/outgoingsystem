...
<head>
  ...
  <title>OUTGOING - View Letter</title>
...
<body class="grey lighten-3">
  ...
  <header>
   <!--Main Navigation-->
    ...
    <?php include_once 'navbar.php' ?> <!-- side navigation & module pop up add user. add admin, add location -->
            ...
            <table id="dtable" class="table  table-bordered">
                <thead class="thead-light"> 
                        ...
                        <?php
                            ...
                            $results = mysqli_query($db, "SELECT * FROM summary WHERE type = 'L' ORDER BY time DESC");
                            $cnt=1;
