...
<tbody>
    ...
    <tr>
      ...
      $query = mysqli_query($conn,"SELECT DISTINCT ID,NAME,SIZE,EMAIL,ADMIN_STATUS,TIMERS,DOWNLOAD,FILENO,LOCATION,FILE_DEPARTMENT FROM upload_files WHERE FILE_DEPARTMENT='SFU' ") or die (mysqli_error($con));
      ...
      <td>
        ...
        <a href="file_update.php?id=<?php echo $row['id']; ?>" title="Edit"><i class="fas fa-user-edit"></i></a>
      </td>
