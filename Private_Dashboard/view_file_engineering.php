      ...
      <div class="card mb-4 wow fadeIn">
        ...
        <div class="card-body d-sm-flex justify-content-between">
          ...
          <h4 class="mb-2 mb-sm-0 pt-1">
            ...
            <span>/</span>
            <span>View File Engineering</span>
          </h4>
<!-- 
...
<tbody>
    ...
    <tr>
      ...
      $query = mysqli_query($conn,"SELECT DISTINCT ID,NAME,SIZE,EMAIL,ADMIN_STATUS,TIMERS,DOWNLOAD,FILENO,LOCATION,FILE_DEPARTMENT FROM upload_files WHERE FILE_DEPARTMENT='Engineering' ") or die (mysqli_error($con));
