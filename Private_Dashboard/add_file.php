...
<h5 class="card-header info-color white-text text-center py-4">
  ...
  <div class="card-body px-lg-5 pt-0">
    ...
    <div class="container">
      <div class="row"><br><br>
        <form action="fileprocess1.php" method="post" enctype="multipart/form-data" >
          <div class="col-md-11">
              <!-- hidden value -->
              ...
              <div class="form-floating mb-3">
               ...
               <!-- form untuk nama file -->
              <div class="form-floating mb-3">
                <input required type="text" name="filename" id="filename" class="form-control" placeholder="">
