      ...
      <div class="row"><br><br>
        <form action="file_update11.php" method="post" enctype="multipart/form-data" >
          <div class="col-md-11">
            ...
            <!-- file date-->
            <div class="form-floating mb-3">
              <input readonly type="month" name="month" class="form-control" value="<?php echo $month;?>">
              <label for="month">File Date</label>
            </div>
            <!-- display file location-->
            <div class="mb-3">
              <h4 type="text" class="form-control" value="<?php echo $location_address;?>">Location: <?php echo $location_address;?></h4>
            </div>
           ...
           <!-- display file name-->
            <div class="form-floating mb-3">
              <input  type="text" name="name" class="form-control" value="<?php echo $filename;?>">
