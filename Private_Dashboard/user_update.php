...
<div class="card">
<h5 class="card-header info-color white-text text-center py-4"><strong>Update User</strong></h5>
  <div class="card-body px-lg-5 pt-0">
    <?php 
        include 'include/connection.php';
        $query = 'SELECT * FROM login_user WHERE id ='.$_GET['id'];
      ...
      <div class="row"><br><br>
        <form action="user_update1.php" method="post" enctype="multipart/form-data" >
          <div class="col-md-11">
            ...
            <div class="form-floating mb-3">
              <input type="" name="position" class="form-control" value="<?php echo $position; ?>">
