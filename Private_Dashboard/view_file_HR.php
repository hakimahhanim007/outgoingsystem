...
<tbody>
    ...
    <tr>
      ...
      $query = mysqli_query($conn,"SELECT DISTINCT ID,NAME,SIZE,EMAIL,ADMIN_STATUS,TIMERS,DOWNLOAD,FILENO,LOCATION,FILE_DEPARTMENT FROM upload_files WHERE FILE_DEPARTMENT='HR' ") or die (mysqli_error($con));
