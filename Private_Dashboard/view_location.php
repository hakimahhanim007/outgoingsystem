    ...
    <tbody>              
        ...
        ?>
          <tr>
              ...
              <td>
                <a href="location_update.php?id_location=<?php echo $row['id_location']; ?>" class="" title="Edit"><i class='far fa-edit'></i></a>
                <a onclick='javascript:confirmationDelete($(this));return false;' href="delete_location.php?id_location=<?php echo htmlentities($row['id_location']); ?>"><i class='far fa-trash-alt' title="Delete"></i></a>
              </td> 
          </tr>
