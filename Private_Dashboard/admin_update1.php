...
<body class="grey lighten-3">
  ...
  <?php
    ...
    $query = 'UPDATE admin_login set name="'.$name.'", admin_user = "'.$admin_user.'", admin_password = "'.$admin_password.'", admin_status = "'.$admin_status.'", admin_position = "'.$admin_position.'" WHERE id ="'.$id.'" ';
